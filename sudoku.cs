...
namespace Sudoku
{
	...
	// Enum, определяющий уровень игры
	...
	// Enum для игровых комбинаций для создания игры.
	...
	public class Sudoku
	{
		...
		/// Создает игру в зависимости от уровня сложности.
		/// </summary>
		/// <param name="level"></param>
		public void GenerateGame(GameLevel level)
		{

			// Инициализирует наборы
			InitialiseSet();
		...
		// Метод позиции
		// Устанавливает позиции случайным образом в зависимости от сложности по алгоритму
		//
		...
		/// <summary>
		/// Метод: проверка на наличие дубликатов
		/// </summary>
		...
		/// <summary>
		/// Метод: проверка изменение ответа
		/// </summary>
		/// <param name="rowPos"></param>
		/// <param name="colPos"></param>
		/// <param name="currentValue"></param>
		...
		/// <summary>
		/// Метод DataSet
		/// динамически создаем XML из массива задач, копия набора ответов набора задач Возвращает как DataSet. После чего привязываем к сетке
		/// </summary>
		...
		private DataSet FormDataSet()
		{
			...
			{
				Console.WriteLine("Ошибка при формировании набора данных", ex.Message);
				return null;
			}
		...
		/// <summary>
		/// Метод: инициализирование набора
		/// Создает набор ответов
		/// </summary>
      ...
      /// <returns></returns>
		...
		/// <summary>
		/// Метод: подстановка номеров
		/// необходим для проверки на наличие дубликатов
		/// </summary>
